...
void main() {
  ...
  group('Cryptograhic service tests', () {
    test('Hashing', () {
      ...
      final Uint8List hash = CryptograhicService.sha256(input);
    ...
    test('HMac calculation', () {
      ...
      final Uint8List hmac = CryptograhicService.verificationCodeFrom(key, data);
    ...
    test('Expand method', () {
      ...
      final Uint8List expanded = CryptograhicService.expand(list, 16);
      expect(expanded.length, 32);

      final Uint8List onceMoreExpanded = CryptograhicService.expand(list, 16);
